...
class BidiTddInkTest {
    ...
    companion object {
        ...
        private val projectRoot = System.getProperty("user.dir")
            .let { if (it.endsWith("mcp-server")) it else "$it/mcp-server" }
            .removeSuffix("/mcp-server")

        private val inkjsPath = "$projectRoot/app/node_modules/inkjs/dist/ink-full.js"
        private val bidifyPath = "$projectRoot/app/renderer/bidify.js"
        ...
        private val bidiTddSource: String by lazy {
            ...
            resource?.readText()
                ?: java.io.File("$projectRoot/app/test/fixtures/bidi_and_tdd.ink").readText()
        }
    }
